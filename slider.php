            ...
            <div class="col-lg-8 col-md-8">
                <div class="slider-area">
                    <div class="slider-active owl-carousel">
                        ...
                        ?>
                        <div style="background-image: url(Admin/Resimler/Slider/<?php echo $slidercek['slider_resim'] ?>) !important;" class="single-slide align-center-left  animation-style-01 bg-2">
