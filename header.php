                                ...
                                <li>
                                    ...
                                    <div class="setting ht-setting">
                                        <ul class="ht-setting-list">
                                            <li><a style="color: black" href="Kullanici">Hesabım</a></li>
                                            <li><a style="color: black" href="Sepet">Sepetim</a></li>
                                            <li><a style="color: black" href="siparisler">Alınan Ürünler</a></li>
                                            <li><a style="color: black" href="sifremidegistir">Şifremi Değiştir</a></li>
                                        </ul>
                                    </div>
                                </li>
                            </ul>
                                ...
                                <li class="hm-minicart">
                                    ...
                                    <div class="minicart">
                                        <ul class="minicart-product-list">
                                            ...
                                            ?>
                                                <li>
                                                <a href="Urun_detay.php" class="minicart-product-image">
                                                    <img src="Admin/Resimler/Urunler/<?php echo $urunlercek['urun_resim'] ?>" alt="cart products">
                                                </a>
                                                <div class="minicart-product-details">
                                                    <h6><a href="Urun_detay.php"><?php echo $urunlercek['urun_baslik'] ?></a></h6>
                                                    <span><?php echo $urunlercek['urun_fiyat'] ?>₺</span>
                                        </div>
                                            <a href="İslem?sepetsil&id=<?Php echo $key ?>"><button class="close" title="Remove"><i class="fa fa-close"></i></button></a>
                                            </li>
                                            <?php } ?>
                                        </ul>
                                        ...
                                        <div class="minicart-button">
                                            ...
                                            <a href="Alisveris.php" class="li-button li-button-fullwidth">
                        ...
                        <div class="hb-menu">
                            <nav>
                                <ul>
                                    ...
                                    <li><a href="İletisim">İLETİŞİM</a></li>
                                </ul>
                            </nav>
                        </div>
